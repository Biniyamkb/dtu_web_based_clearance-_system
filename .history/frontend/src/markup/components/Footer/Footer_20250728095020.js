            ...
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">
                    54B, Tailstoi Town 5238 MT, <br /> La city, IA 522364 Debre
                    Tabor University P.O. Box 272 Debre Tabor, Ethiopia
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="footer-column col-lg-4">
                <div className="widget widget_about">
                  <div className="text">
                    ...
                    added activity tsdfffsdfdsfsdo beta test. Override the
