  ...
  return (
    <div>
      ...
      <div className="list-group">
        ...
        <a href="/admin/user" className="list-group-item">users</a>
        <a href="/admin/report" className="list-group-item">New Report</a>
        <a href="/admin/add-user" className="list-group-item">Add User</a>
        <a href="/admin/stafs" className="list-group-item">Stafs</a>
