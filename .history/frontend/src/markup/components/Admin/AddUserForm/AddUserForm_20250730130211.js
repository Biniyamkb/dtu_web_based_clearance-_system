...
function AddUser(props) {
  ...
  const handleSubmit = (e) => {
    ...
    newUser
      ...
      .then((data) => {
        console.log(data)
        console.log("this is inside newUser function")
        if (data.error) {
  ...
  return (
    <section cllassNameName="contact-section">
      <div cllassNameName="auto-container">
        <div cllassNameName="contact-title">
          <h2>Add a new User</h2>
        </div>
        <div cllassNameName="row clearfix">
