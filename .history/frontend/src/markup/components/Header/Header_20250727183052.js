            ...
            <div class="flex flex-col md:flex-row items-center">
              <div class="md:w-1/2 mb-10 md:mb-0">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">
                  Welcome to DTU Management System
                </h1>
                <p class="text-lg mb-8 opacity-90">
                  A comprehensive platform for students, faculty, and
                  administrators to manage university resources efficiently.
                </p>
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <button class="bg-white text-blue-700 font-medium py-3 px-8 rounded-full hover:bg-opacity-90 transition duration-300 shadow-lg">
                    Get Started
                  </button>
                  <button class="bg-transparent border-2 border-white text-white font-medium py-3 px-8 rounded-full hover:bg-white hover:bg-opacity-10 transition duration-300">
                    Learn More
                  </button>
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div class="feature-card bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-600">
                  Easily register for courses, access materials, and track your
              ...
              <div class="feature-card bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-600">
                  Never miss a deadline with our comprehensive assignment
              ...
              <div class="feature-card bg-white p-6 rounded-xl shadow-md">
                ...
                <p class="text-gray-600">
                  Connect with professors and peers through our integrated
            ...
            <div class="space-y-6 max-w-4xl mx-auto">
              <div class="announcement-card bg-white p-6 rounded-lg shadow-sm">
                ...
                <p class="mt-3 text-gray-600">
                  Registration for the Fall 2023 semester is now open. Please
                  log in to your student portal to register for courses before
                  July 31st.
                </p>
                <a
                  href="#"
              ...
              <div class="announcement-card bg-white p-6 rounded-lg shadow-sm">
                ...
                <p class="mt-3 text-gray-600">
                  The university library has added new digital resources for
                  engineering and computer science students. Access them through
                  your student portal.
                </p>
                <a
                  href="#"
              ...
              <div class="announcement-card bg-white p-6 rounded-lg shadow-sm">
                ...
                <p class="mt-3 text-gray-600">
                  Scheduled maintenance will take place in the Engineering
                  building from June 20-25. Some labs will be temporarily
