...
//import a custom hook context hook
          ...
          <div className="auto-container">
            <div className="inner-container">
              ...
              <div className="right-column">
               {isLogged ?(<div className="link-btn">
                <div className="phone-number"> <strong></strong>Welcome{user?.user_first_name}</div>
          ...
          <div className="auto-container">
            <div className="inner-container">
              <div className="logo-box">
                <div className="logo">
                  <a href="/">
                    <img src={logo} alt="logo" className="logodtu" />
                  </a>
                </div>
              </div>
              <div className="right-column">
