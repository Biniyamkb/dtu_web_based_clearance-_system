            ...
            <div className="footer-info-box col-md-4 col-sm-6 col-xs-12">
              <div className="info-inner">
                <div className="content">
                  ...
                  <div className="text">
                    Debre Tabor University P.O. Box 272 <br /> Debre Tabor,
                    Ethiopia
                  </div>
                </div>
              </div>
            ...
            <div className="row clearfix">
              <div className="footer-column col-lg-4">
                <div className="widget widget_about">
                  <div className="text">
                    Empower yourself with essential digital skills by mastering
                    a CMS, paving the way for future opportunities in today's
